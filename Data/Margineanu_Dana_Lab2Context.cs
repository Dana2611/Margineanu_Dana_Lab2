...
namespace Margineanu_Dana_Lab2.Data
{
    public class Margineanu_Dana_Lab2Context : DbContext
    {
        ...
        public DbSet<Margineanu_Dana_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Margineanu_Dana_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Margineanu_Dana_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
